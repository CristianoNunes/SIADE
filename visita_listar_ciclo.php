                                        ...
                                        <div class="form-group">
                                            ...
                                            $agente = $_POST['agente_id_agente'];
                                                ...
                                                $result = mysql_query("SELECT * FROM `visita` as v    
                                                    ...
                                                    WHERE ciclo_id_ciclo='$ciclo' AND agente_id_agente=$agente
                                                    ") or trigger_error(mysql_error()); 
                                                while($row = mysql_fetch_array($result)){ 
                                                foreach($row AS $key => $value) { $row[$key] = stripslashes($value); } 
                                                echo "<tr>";
                                                echo "<td valign='top'>" . nl2br( $row['ciclo_id_ciclo']) . "</td>";
                                                ...
                                                echo "<td valign='top'>" . nl2br( $row['imovel_id_imovel']) . "</td>";  
